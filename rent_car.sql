...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Bulan Mei 2019 pada 05.39
...
('1', 'Syifa', 'Malang', '0987654321', 'syifa', '123'),
('2', 'Aldi', 'Malang', '09876543212', 'aldy', '123'),
('3', 'Iqbaal', 'Jakarta', '098765432125', 'baalee', '281299'),
('4', 'Dia', 'Jakarta', '09876543212', 'aku', '1234');
...
INSERT INTO `mobil` (`id_mobil`, `nomor_mobil`, `merk`, `jenis`, `warna`, `Stok`, `tahun_pembuatan`, `biaya_sewa_per_hari`) VALUES
('1', 'B 12345', 'BMW', 'SPORT', 'BIRU', 1, '2014', 21000000),
('2', 'N 12345', 'avanza', 'biasa', 'hitam', 1, '2013', 1000000),
('3', 'B 12345', 'jazz', 'biasa', 'hitam', 1, '2006', 1000000),
('4', 'D 567 RE', 'avanza', 'biasa', 'BIRU', 1, '2010', 1000000);
...
('1', 'Aldy Maldinii', 'Jakarta', '098765432'),
('2', 'Syifa', 'Jakarta', '0987654321\r\n'),
('3', 'hoi', 'Jakartaa', '09876543212');
...
('1', '2', '1', '2', '2019-05-02', '2019-05-03', 20000000),
('2', '1', '1', '2', '2019-05-19', '2019-05-22', 30000000);
...
ALTER TABLE `sewa`
  ...
  ADD KEY `id_karyawan` (`id_karyawan`,`id_pelanggan`),
